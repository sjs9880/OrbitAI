...
사용자의 입력을 분석하여 다음 5가지 중 하나로 분류하고 키워드만 출력하세요. 설명은 필요 없습니다.
1. [SUMMARIZE]: "이 페이지 요약해줘", "세 줄 요약 좀", "전체 내용 정리" 등 전체적인 요약 요청.
2. [READ_PAGE]: "이 내용에 대해 어떻게 생각해?", "이 제품 가격이 얼마야?", "결론이 뭐야?", "작성자가 누구야?" 등 페이지 내용을 참고해야 답할 수 있는 질문.
3. [READ_COMMENTS]: "사람들 반응 어때?", "댓글 분위기 알려줘", "욕하는 사람 많아?", "베플 내용이 뭐야?" 등 여론/댓글 관련 질문.
4. [SEARCH]: "오늘 날씨", "삼성전자 주가", "최신 뉴스" 등 외부 검색이 필요한 질문.
5. [GENERAL]: "안녕", "파이썬 코드 짜줘" 등 일반적인 대화.
`;
